...
Includes the Header (Title, Version, Stats) and Status Bar.
"""
...
from ttkbootstrap.constants import LEFT, TOP, X, Y
...
class Header(ttk.Frame):
    ...
    def __init__(
        ...
        self.donation_link: Optional[ttk.Label] = None
    ...
    def _build_ui(
        ...
        # Stack Title and Version vertically
        title_version_frame = ttk.Frame(left_frame)
        title_version_frame.pack(side=LEFT, padx=(0, 20), anchor="w")
        ...
        # The main_window updates CONFIG['version'], so we just read it here.
        ...
        self.version_label.pack(side=TOP, anchor="w", pady=(0, 2))

        # Links Row (Donations, Twitter, Github)
        links_frame = ttk.Frame(title_version_frame)
        links_frame.pack(side=TOP, anchor="w", pady=(2, 0))
        ...
        self.donation_link.pack(side=LEFT, padx=(0, 5))
        ...
        # --- Stats Area (Price, Hashrate, Diff) ---
    ...
    def _create_stat_frame(
        self, parent: ttk.Frame, title_key: str, value_var: ttk.StringVar, bootstyle: str
    ...
    def set_controls_state(self, is_active: bool) -> None:
        """Enables or disables header controls."""
