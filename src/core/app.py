...
class KaspaApp:
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            logger.info(f"PERF: MainWindow initialization took {end_mw - start_mw:.4f} seconds.")
            logger.info("KaspaApp initialized successfully.")
            
        except KaspaError as e:
            logger.critical(f"A critical, known error occurred during app initialization: {e}", exc_info=True)
            raise
    ...
    def run(self) -> None:
        ...
        try:
            ...
            logger.critical(f"An unexpected error occurred in the main app loop: {e}", exc_info=True)
        finally:
    ...
    def shutdown(self) -> None:
        ...
        if hasattr(self, 'main_window') and hasattr(self.main_window, 'shutdown_services'):
